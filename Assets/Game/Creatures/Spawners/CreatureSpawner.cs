...
namespace Asce.Game.Spawners
{
    ...
    public abstract class CreatureSpawner<T> : GameComponent, ISpawner<T>, IOptimizedComponent where T : Creature
    {
        [SerializeField, Readonly] protected SpawnPositionController _positionController;

        [Space]
        [SerializeField] protected T _prefab;
        [SerializeField] protected List<T> _creatures = new();
        ...
        public List<T> Creatures => _creatures;
        public bool IsMaxSpawnCount => _maxSpawnCount != -1 && _creatures.Count >= _maxSpawnCount;
        ...
        {            
            ...
            T newCreature = CreatureSpawnManager.Instance.Spawn<T>(_prefab, position, Quaternion.identity);
        ...
        public virtual void DespawnImmediately(T creature)
        {
            CreatureSpawnManager.Instance.Despawn(creature);
