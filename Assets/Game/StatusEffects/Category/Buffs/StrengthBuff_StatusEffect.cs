...
{
    public class StrengthBuff_StatusEffect : StatusEffect
    {
        ...
        protected virtual void ApplyStats()
        {
			...
			{
				_agents["Strength"] = hasStrength.Strength.AddAgent(Author, $"strength buff effect", _strength, StatValueType.Flat);
			}
        }
