...
{
	public class AleUseEvent : UseEvent
    {
		[SerializeField] private float _value = 30;
		[SerializeField] private float _buffRatio = 0.15f;
        ...
        public override bool OnUse(object sender, UseEventArgs args)
        {
            ...
            {
                hasSustenance.SustenanceGroup.Thirst.AddToCurrentValue(null, $"Ale", _value);
            }
			
            StatusEffectsManager.Instance.SendEffect<ResistanceBuff_StatusEffect>(null, args.User, new EffectDataContainer()
			{
				Level = 1,
				Strength = _buffRatio,
