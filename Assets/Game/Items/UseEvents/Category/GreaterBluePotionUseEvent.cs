...
{
    public class GreaterBluePotionUseEvent : UseEvent
    {
		[SerializeField] private float _buffRatio = 0.36f;
        ...
        public override bool OnUse(object sender, UseEventArgs args)
        {
            ...
            {
                hasSustenance.SustenanceGroup.Thirst.AddToCurrentValue(null, $"Greater Blue Potion buff", 30f);
            }
