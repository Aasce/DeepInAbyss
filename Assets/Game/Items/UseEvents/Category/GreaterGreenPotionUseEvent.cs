...
{
    public class GreaterGreenPotionUseEvent : UseEvent
    {
        [SerializeField] private float _healPerTime = 5f;
        ...
        public override bool OnUse(object sender, UseEventArgs args)
        {
            ...
            {
                hasSustenance.SustenanceGroup.Thirst.AddToCurrentValue(null, $"Greater Green Potion buff", 30f);
            }
