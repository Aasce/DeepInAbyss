...
{
	public class MinorBluePotionUseEvent : UseEvent
    {
		[SerializeField] private float _buffRatio = 0.2f;
        ...
        public override bool OnUse(object sender, UseEventArgs args)
        {
            ...
            {
                hasSustenance.SustenanceGroup.Thirst.AddToCurrentValue(null, $"Minor Blue Potion buff", 25f);
            }
