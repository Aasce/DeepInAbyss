...
{
	public class WineUseEvent : UseEvent
    {
        ...
        public override bool OnUse(object sender, UseEventArgs args)
        {
            ...
            {
                hasSustenance.SustenanceGroup.Thirst.AddToCurrentValue(null, $"Wine", _value);
            }
			
            StatusEffectsManager.Instance.SendEffect<StrengthBuff_StatusEffect>(null, args.User, new EffectDataContainer()
			{
				Level = 1,
				Strength = _buffRatio,
