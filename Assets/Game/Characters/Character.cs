...
{
    public class Character : Creature, IControllableCharacter, IHasView<CharacterView>, IHasAction<CharacterAction>, IHasStats<CharacterStats, SO_CharacterBaseStats>, IHasEquipment<CharacterEquipment>, IHasUI<CharacterUI>
    {
